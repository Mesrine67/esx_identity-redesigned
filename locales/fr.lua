Locales['fr'] = {
  ...
  ['no_identifier'] = '[ESX Identity]\nUn problème est survenu lors du chargement de votre personnage !\nCode d\'erreur : identifier-missing\n\nCela est dû à l\'absence de votre identifiant. Veuillez réessayer plus tard ou signaler ce problème au propriétaire du serveur.',
  ['missing_identity'] = '[ESX Identity]\nUn problème est survenu lors du chargement de votre personnage !\nCode d\'erreur : identity-missing\n\nIl semblerait que votre identité soit manquante, essayez de vous reconnecter.',
